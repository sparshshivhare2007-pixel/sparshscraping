...
session_strings = [
    ...
    # Add other session strings here
    "ANOTHER_SESSION_STRING",
    "YET_ANOTHER_SESSION_STRING"
]

clients = []

for session_string in session_strings:
    clients.append(pyrogram.Client(
        'mrdaxx_scrapper',
        api_id='27649783',
        api_hash='834fd6015b50b781e0f8a41876ca95c8',
        session_string=correct_padding(session_string)  # Ensure correct padding
    ))
...
for client in clients:
    client.add_handler(pyrogram.handlers.MessageHandler(astro, filters.text))
